...
int main(){
    ...
    do{
        printf("Em qual palavra voce deseja acrescentar palavra(1 ou 2)?");
        scanf("%d", &opc_pilha);
    ...
    if(iguais  && vazia(p1) && vazia(aux)) printf("As pilhas são Palíndromos");
    else printf("As pilhas nao sao Palíndromo");
